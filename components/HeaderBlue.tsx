      ...
      items: [
        {
          ...
          shortDescription: "Decision Tree",
          to: "/merchandizing-optimizer/cdt",
          icon: TreePine,
          highlight: true,
        ...
        {
          name: "CDT Deep Dive",
          description: "Full 4-phase CDT dashboard — switching matrices, Yule's Q, CHAID, CART, and assortment recommendations",
          shortDescription: "CDT Dashboard",
          to: "/merchandizing-optimizer/cdt-analysis",
          icon: Activity,
          highlight: true,
