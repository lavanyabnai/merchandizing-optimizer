  ...
  return (
    <div className="mb-6">
      <div className="flex items-center gap-3 mb-1">
        <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-orange-600 text-white text-sm font-bold">{phase}</span>
...
function OverviewSection() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={0} title="Executive Summary" subtitle="SKU Optimizer — Greedy & MILP assortment selection for CSD category" />
...
function Phase1Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={1} title="Data Exploration" subtitle="Understanding SKU-level economics, shelf productivity, and promotional dynamics before optimization" />
...
function Phase2Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={2} title="Constraint Definition" subtitle="Business rules that shape the feasible region — must-carry items, brand limits, price tiers, and variant requirements" />
...
function Phase3Section() {
  return (
    <div className="space-y-6">
      <SectionHeader phase={3} title="Greedy Heuristic" subtitle="Step-by-step greedy selection: add the highest-value feasible SKU at each step until shelf is full" />
...
function Phase4Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={4} title="MILP Exact Solution" subtitle="Branch-and-bound optimal solution vs greedy heuristic — comparing decisions, revenue, and margin" />
...
function Phase5Section() {
  return (
    <div className="space-y-6">
      <SectionHeader phase={5} title="Solution Analysis & What-If Scenarios" subtitle="Sensitivity analysis on constraints, scenario planning, and actionable recommendations" />
    ...
    <div className="max-w-[1400px] mx-auto">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid grid-cols-6 w-full mb-6">
          ...
          <TabsTrigger value="constraints">2. Constraints</TabsTrigger>
          <TabsTrigger value="greedy">3. Greedy</TabsTrigger>
          <TabsTrigger value="milp">4. MILP Solution</TabsTrigger>
          <TabsTrigger value="analysis">5. Analysis</TabsTrigger>
        </TabsList>
