  ...
  return (
    <div className="mb-6">
      <div className="flex items-center gap-3 mb-1">
        <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-indigo-600 text-white text-sm font-bold">{phase}</span>
...
function OverviewSection() {
  return (
    <div className="space-y-6">
      <SectionHeader phase={0} title="Executive Summary" subtitle="Monte Carlo simulation — stress-testing the MILP-optimal assortment under demand & elasticity uncertainty" />
...
function Phase1Section() {
  return (
    <div className="space-y-6">
      <SectionHeader phase={1} title="Input Uncertainty" subtitle="Mapping the uncertain parameters, their distributions, and how each feeds into the simulation engine" />
...
function Phase2Section() {
  return (
    <div className="space-y-6">
      <SectionHeader phase={2} title="Simulation Results" subtitle="5,000 trial outcomes — revenue distribution, convergence diagnostics, and percentile analysis" />
...
function Phase3Section() {
  return (
    <div className="space-y-6">
      <SectionHeader phase={3} title="Scenario Stress Tests" subtitle="Named scenarios with correlated parameter shifts — recession, competitive entry, supply disruption" />
...
function Phase4Section() {
  return (
    <div className="space-y-6">
      <SectionHeader phase={4} title="Decision Confidence" subtitle="How confident are we in each assortment decision? Monte Carlo transforms point estimates into probability-backed confidence scores" />
...
function Phase5Section() {
  return (
    <div className="space-y-6">
      <SectionHeader phase={5} title="Stakeholder Report & Recommendations" subtitle="Final outputs — confidence intervals for executive review, risk mitigation actions, and pipeline next steps" />
    ...
    <div className="max-w-[1400px] mx-auto">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid grid-cols-6 w-full mb-6">
          ...
          <TabsTrigger value="inputs">1. Uncertainty</TabsTrigger>
          <TabsTrigger value="results">2. Results</TabsTrigger>
          <TabsTrigger value="scenarios">3. Stress Tests</TabsTrigger>
          <TabsTrigger value="confidence">4. Confidence</TabsTrigger>
          <TabsTrigger value="recommendations">5. Report</TabsTrigger>
        </TabsList>
