  ...
  return (
    <div className="mb-6">
      <div className="flex items-center gap-3 mb-1">
        <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-teal-100 text-slate-900 text-sm font-bold">{number}</span>
    ...
    <div className="max-w-[1400px] mx-auto">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid grid-cols-5 w-full mb-6">
          ...
          <TabsTrigger value="phase1">1. Data Exploration</TabsTrigger>
          <TabsTrigger value="phase2">2. Category Profile</TabsTrigger>
          <TabsTrigger value="phase3">3. CDT Build</TabsTrigger>
          <TabsTrigger value="phase4">4. Synthesis</TabsTrigger>
        </TabsList>
...
function OverviewSection() {
  return (
    <div className="space-y-6">
      <SectionHeader number="0" title="Executive Summary" subtitle="Consolidated findings from the Consumer Decision Tree analysis of Carbonated Soft Drinks" />
...
function Phase1Section() {
  return (
    <div className="space-y-6">
      <SectionHeader number="1" title="Data Inventory & Exploration"
...
function Phase2Section() {
  return (
    <div className="space-y-6">
      <SectionHeader number="2" title="Category Selection & Deep Exploration"
...
function Phase3Section() {
  return (
    <div className="space-y-6">
      <SectionHeader number="3" title="CDT Construction — Multi-Method Evidence"
...
function Phase4Section() {
  return (
    <div className="space-y-6">
      <SectionHeader number="4" title="Synthesis & Assortment Recommendations"
