...
function SectionHeader({ phase, title, subtitle }: { phase: number; title: string; subtitle: string }) {
  return (
    <div className="mb-6">
      <div className="flex items-center gap-3 mb-1">
        <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-teal-100 text-slate-900 text-sm font-bold">{phase}</span>
...
function Phase1Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={1} title="Data & Setup" subtitle="SKU candidate pool, space budget constraints, and MNL utility inputs from upstream models" />
...
function Phase2Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={2} title="Column Generation" subtitle="Iteratively expand the assortment by adding the SKU with highest marginal contribution" />
      ...
      <AnalysisCard title="Column Generation Methodology" badge="Iterative" insight="Instead of enumerating all 2^44 = 17.6 trillion possible assortments, Column Generation starts with a small feasible set and iteratively adds the most promising SKU.">
        <div className="grid grid-cols-3 gap-4 py-2">
          <div className="bg-slate-50 rounded-lg p-4">
            <h4 className="text-sm font-semibold text-slate-700 mb-2">1. Master Problem (Restricted)</h4>
          ...
          <div className="bg-slate-50 rounded-lg p-4">
            <h4 className="text-sm font-semibold text-slate-700 mb-2">2. Pricing Subproblem</h4>
          ...
          <div className="bg-slate-50 rounded-lg p-4">
            <h4 className="text-sm font-semibold text-slate-700 mb-2">3. Termination</h4>
...
function Phase3Section() {
  return (
    <div className="space-y-6">
      <SectionHeader phase={3} title="Benders Decomposition" subtitle="Master-subproblem decomposition with optimality and feasibility cuts for MNL-based assortment optimization" />
...
function Phase4Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={4} title="Hierarchical Multi-Level Decomposition" subtitle="Solve by CDT hierarchy: Category > Sub-category > Brand > SKU for 37x speed improvement" />
...
function Phase5Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={5} title="Comparison & Synthesis" subtitle="Side-by-side evaluation of all three solver approaches with consensus assortment recommendation" />
    ...
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-sm text-slate-500 mt-1">Column Generation · Benders Decomposition · Hierarchical Multi-Level · dunnhumby CSD · 44 SKUs · 4 Clusters</p>
        </div>
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="grid grid-cols-6 w-full mb-6">
            <TabsTrigger value="overview">Overview</TabsTrigger>
            <TabsTrigger value="exploration">1. Data & Setup</TabsTrigger>
            <TabsTrigger value="colgen">2. Column Gen</TabsTrigger>
            <TabsTrigger value="benders">3. Benders</TabsTrigger>
            <TabsTrigger value="hierarchical">4. Hierarchical</TabsTrigger>
            <TabsTrigger value="comparison">5. Comparison</TabsTrigger>
          </TabsList>
