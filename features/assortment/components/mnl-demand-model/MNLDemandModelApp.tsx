...
function OverviewSection() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={0} title="Executive Summary" subtitle="MNL demand model overview for CSD category — Cola focus" />
...
function Phase1Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={1} title="Data Exploration" subtitle="Understanding the dunnhumby CSD transaction data — distributions, trends, and early patterns" />
...
function Phase2Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={2} title="Choice Set Construction" subtitle="Defining the alternatives, attributes, and decision structure for MNL estimation" />
...
function Phase3Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={3} title="MNL Model Estimation" subtitle="Maximum likelihood estimation of multinomial logit coefficients and model diagnostics" />
...
function Phase4Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={4} title="Model Outputs — Probabilities & Elasticities" subtitle="Choice probabilities, substitution patterns, and price elasticities derived from the MNL model" />
...
function Phase5Section() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader phase={5} title="Assortment Optimization & Recommendations" subtitle="Using MNL outputs to optimize SKU selection, simulate delistings, and generate actionable recommendations" />
    ...
    <div className="max-w-[1400px] mx-auto">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid grid-cols-6 w-full mb-6">
          ...
          <TabsTrigger value="choiceset">2. Choice Set</TabsTrigger>
          <TabsTrigger value="estimation">3. Estimation</TabsTrigger>
          <TabsTrigger value="outputs">4. Outputs</TabsTrigger>
          <TabsTrigger value="optimization">5. Optimization</TabsTrigger>
        </TabsList>
